...
const changeCaseItems: NavItem[] = [
  { href: "/sentence-case", label: "Change case to Sentence Case" },
  { href: "/lowercase", label: "Change case to Lowercase" },
  { href: "/uppercase", label: "Change case to Uppercase" },
  { href: "/title-case", label: "Change case to Title Case" },
  { href: "/camel-case", label: "Change case to Camel Case" },
];

const editItems: NavItem[] = [
  { href: "/edit/text-trim", label: "Edit: Trim text" },
  { href: "/edit/remove-spaces", label: "Edit: Remove spaces" },
  { href: "/edit/find-replace", label: "Edit: Find & replace" },
];

const generateItems: NavItem[] = [
  { href: "/generate/quotes", label: "Generate: Quotes" },
  { href: "/generate/lorem-ipsum", label: "Generate: Lorem ipsum" },
  { href: "/generate/passwords", label: "Generate: Passwords" },
];
  ...
  return (
    <header className="relative z-30">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-4 pt-6 sm:px-6">
        <Link href="/tools" className="flex items-center gap-2" aria-label="Home">
